...
// Type: GTA_SA_Chaos.util.VehicleNames
...
namespace GTA_SA_Chaos.util
{
  ...
  {
    private static readonly string[] vehicleNames = new string[212]
    {
      "Landstalker",
      "Bravura",
      "Buffalo",
    ...
    public static string GetVehicleName(int modelID) => VehicleNames.vehicleNames[Math.Max(400, Math.Min(modelID, 611)) - 400];
  }
}
